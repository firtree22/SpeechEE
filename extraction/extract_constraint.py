...
class TreeConstraintDecoder(ConstraintDecoder):
    ...
    #     if special_index_token ==[]:
    #         last_special_index,last_special_token =0,0
    #     else: last_special_index, last_special_token = special_index_token[-1] 
